...
dpF = xlsread('patientdata.xlsx'); %random path
dpF=transpose(dpF); %para path random
...
writematrix(historic,'historico.xlsx','Sheet',1,'Range','A1')%RANDOM